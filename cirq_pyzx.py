##################
"""
https://github.com/oumjunior/CirqPyZX/edit/master/cirqpyzx/cirq_pyzx.py
"""
#################
            ...
            for op in moment:
                if isinstance(op, cirq.GateOperation) and op.gate == cirq.T:
                    ...
                    self.circuit_zx.add_gate(
                        zx.gates.T(qubit_id_to_zx_id[key], adjoint=True)
                    )
                    ...
                    key = qbts[0]
                    self.circuit_zx.add_gate(
                        zx.gates.S(qubit_id_to_zx_id[key], adjoint=True)
                    )
                    ...
                    self.circuit_zx.add_gate(
                        zx.gates.CNOT(
                            control=qubit_id_to_zx_id[ctrl],
